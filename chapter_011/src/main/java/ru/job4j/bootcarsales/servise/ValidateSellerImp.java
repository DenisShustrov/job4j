...
import ru.job4j.bootcarsales.repository.SellerCrudRepository;
...
public class ValidateSellerImp implements ValidateSeller {
    ...
    @Override
    public Seller findSeller(String name, String login) {
        return sellerCrudRepository.findSellerByNameAndLogin(name, login);
    }
